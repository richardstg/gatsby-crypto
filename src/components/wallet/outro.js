          ...
          >
            ...
            >
              ...
              <p className={articleStyles.text}>
                ...
                vill komma igång och investera mindre belopp räcker det
                troligtvis med att hålla kryptovalutorna i en mjukvaruplånbok,
                alternativt i börsernas integrerade plånböcker. Man ska dock
                komma ihåg att mjukvaruplånböcker och börser hackats förr. Om
                man håller större belopp bör man därmed i ett så tidigt stadie
                som möjligt se sig om efter en hårdvaruplånbok. Detta är den i
                särklass säkraste formen av förvaring. Ett köp av en TREZOR
                eller Ledger bör således betraktas som väl investerade pengar.
              </p>
            </div>
          </Col>
        </Row>
