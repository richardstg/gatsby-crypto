        ...
        <Row>
          ...
          >
            ...
            <p className={articleStyles.text}>
              ...
              Något vi uppskattar är att man genom Exodus även får tillgång till
              en kryptobörs där man kan handla valutor utan att lämna plånboken.
              Varje köp medför dock en avgift, och det är dessa avgifter som
              företaget livnär sig på.
            </p>
            <p className={articleStyles.text}>
              Exodus-plånboken kan kommas åt både genom mobilappen och på
              datorn. För att komma in i plånboken används ett personligt
              lösenord och vid uppstarten ges man en backup-fras. Backup- frasen
              kan användas utifall man tappar bort sin mobil eller glömmer
              lösenordet.
            </p>
            <ul>
              <li>
