          ...
          >
            ...
            >
              ...
              <p className={articleStyles.text}>
                ...
                Ledgern har, till skillnad från konkurrenten TREZOR, två lager
                av säkerhet i stället för ett. Man har dessutom implementerat
                ett antal andra funktioner som gör den ännu säkrare. En av dessa
                är randomisering av siffror vid intryckning av pinkod, vilket
                omöjliggör för gissning genom slitage på knappar.
              </p>
              <p className={articleStyles.text}>
                En Ledger Nano S, den billigaste och populäraste modellen,
                kostar 59 EUR och har sålt i mer än 1,4 miljoner exemplar
                världen över. Deras senaste och dyraste modell, Ledger Nano X,
                går på 120 EUR. Enligt oss är båda modellerna utmärkta val som
                ger en högsta möjliga säkerhet. Deras användargränssnitt är
                otroligt intuitivt och gör plånboken enkel att använda, oavsett
                vilken teknisk nivå man besitter.
              </p>
              <p className={articleStyles.text}>
                ...
                Användaren förses även med en backup-fras som kan användas för
                att få tillgång till sina kryptovalutor från en annan enhet.
                Kryptovalutorna går därmed inte förlorade utifall man tappar
                bort sin Ledger.
              </p>
              <ul>
                <li>
