        ...
        <Row>
          ...
          >
            ...
            >
              ...
              <p className={articleStyles.text}>
                På plattformen kan man använda upp till 100x hävstång. Tradare
                kan ta både långa och korta positioner, och därmed profitera
              ...
              <p className={articleStyles.text}>
                ...
                aldrig varit med om tekniska bekymmer orsakade av
                överbelastning, problem med stop-loss eller slippadge på
                marknadsordrar. Detta har gjort att många professionella traders
                som tidigare använt sig av Bitmex övergått till Bybit. Trots att
                Bybit är en relativt ny aktör så har man hög likviditet. Traders
                som handlar med positioner på mindre än 5 000 000 USD bör därmed
                inte oroa sig.
              </p>
              <p className={articleStyles.text}>
