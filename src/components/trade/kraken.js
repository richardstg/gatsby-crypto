        ...
        <Row>
          ...
          >
            ...
            <p className={articleStyles.text}>
              Kraken grundades 2011 och deras kryptobörs lanserades 2013. Detta
              gör dem till en av de äldsta och mest väletablerade kryptobörserna
              i världen. Tjänsten har vidareutvecklats genom åren och idag
              erbjuder man en avancerad tradingplattform där man kan trada
              kryptovalutor, både med och utan hävstång. De anses vara en av de
              pålitligaste alternativen för professionella och institutionella
              investerare.
            </p>
            <p className={articleStyles.text}>
              ...
              (BCH). Man kan köpa kryptovalutor genom banköverföring, vilket gör
              det relativt smidigt för nybörjare.
            </p>
            <p className={articleStyles.text}>
              Det är allmänt känt att en av Krakens största fördelar utgörs av
              deras höga säkerhet och låga avgifter. Ett område de tidigare fått
              viss kritik för är deras kundtjänst. Detta upplever dock vi och
              många andra att man åtgärdat. Idag tillhandahåller man en
              live-chat öppen 24/7, dit man kan vända sig när man har frågor.
              Enligt vissa överträffar deras kundtjänst numera den hos Coinbase.
            </p>
            <p className={articleStyles.text}>
