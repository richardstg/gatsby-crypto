          ...
          <Col xs={12} md={{ size: 8, offset: 2 }}>
            ...
            >
              <p className={articleStyles.text}>
                ...
                att ge information och support till sina användare. Detta gör
                dem ideala för individer som är nya inom kryptovärlden och ska
                göra sina allra första investeringar.
              </p>
              <p className={articleStyles.text}>
                Man kan köpa några av de populäraste kryptovalutorna, såsom
                Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC), Ripple (XRP),
                Cardano (ADA), Tezos (XTZ) och EOS. Köpen kan göras från i
                princip hela världen med både bank/kreditkort och
                banköverföring. Det går även att sälja kryptovalutor för lokala
                valutor och få pengarna överförda till sitt bankkonto i Sverige.
              </p>
              <p className={articleStyles.text}>
                ...
                utvärdering av{" "}
                <Link to="/planbocker">de bästa kryptoplånböckerna</Link>.
              ...
              <p className={articleStyles.text}>
                ...
                kryptovalutor och vill betala de allra lägsta avgifterna så
                finns det bättre alternativ. Om man däremot är ute efter en
                smidig tjänst utan onödigt krångel och som erbjuder god
                kundsupport, då är Coinmama ett av de bättre alternativen.
              </p>
              <ul>
                <li>
                  <p className={articleStyles.text}>
