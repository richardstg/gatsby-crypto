        ...
        <Row>
          <Col xs={12} md={{ size: 8, offset: 2 }}>
            ...
            <p className={articleStyles.text}>
              ...
              kryptovalutor och göra dem tillgängliga för allmänheten. Visionen
              är vara en av de mest pålitliga och användarvänliga börserna,
              något de hittills uppnått med stor framgång.
            </p>
            <p className={articleStyles.text}>
              Man har fokuserat på att introducera nya investerare in i
              kryptovärlden och möjliggöra för dem att köpa de största
              kryptovalutorna, däribland Bitcoin (BTC), Ethereum (ETH), Litecoin
              (LTC), Ripple (XRP), EOS, Tezos (XTZ), Chainlink (LINK), Cosmos
              (ATOM) och Basic Attention Token (BAT). Det finns även
              funktionalitet som stödjer återkommande köp. På så vis kan man
              automatisera investeringarna enligt ett förutbestämt tidschema,
              exempelvis varje dag, vecka eller månad. Användarna har möjlighet
              att förvara kryptovalutorna i den integrerade plånboken och från
              den utföra de transaktioner som önskas.
            </p>
            <p className={articleStyles.text}>
              På Coinbase kan man köpa kryptovalutor för lokala valutor,
              exempelvis svenska kronor, både genom bank/kreditkort och
              banköverföring. Man kan även sälja och få pengarna överförda till
              sitt bankkonto i Sverige.
            </p>
            <p className={articleStyles.text}>
              Deras tjänst hör till en av de mest lättanvända på marknaden. Även
              personer med låg teknisk nivå kan känna sig trygga. Detta i
            ...
            <p className={articleStyles.text}>
              ...
              till lika avancerad funktionalitet som hos vissa andra aktörer, i
              huvudsak med avseende på trading. Om man är ute efter detta
