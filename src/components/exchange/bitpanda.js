          ...
          <Col xs={12} md={{ size: 8, offset: 2 }}>
            ...
            >
              <p className={articleStyles.text}>
                ...
                kryptovalutor. Både bank/kreditkort och banköverföring
                accepteras.
              </p>
              <p className={articleStyles.text}>
                På Bitpanda kan man köpa och sälja några av de allra populäraste
                kryptovalutorna, bl.a. Bitcoin, Ethereum, Ripple, Litecoin,
                Tezos, EOS, Chainlink, Cardano, 0x och IOTA.
                Användargränssnittet är tilltalande och tjänsten enkel att
                använda. Kundsupporten har också ett gott rykte om sig och
                ligger klart över genomsnittet för branschen. Liksom på Coinbase
                finns det en integrerad plånbok där man kan förvara sina
                kryptovalutor, vilket förenklar för förstagångsköpare.
              </p>
              <p className={articleStyles.text}>
                Likheterna med Coinbase är många, och om Coinbase anses vara
                ledaren så kan Bitpanda liknas vid uppstickaren med siktet
                inställt på att bli nummer ett. Bitpanda har något lägre
                avgifter, även om det inte är helt transparent då avgifterna
                inte redovisas separat, utan i stället ligger inbakade i
                totalpriset.
              </p>
              <p className={articleStyles.text}>
