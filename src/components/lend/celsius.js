        ...
        <Row>
          <Col xs={12} md={{ size: 8, offset: 2 }}>
            ...
            >
              ...
              <p className={articleStyles.text}>
                Man använder sig av ett räntesystem där räntan är beroende på
                hur mycket man håller av deras egna kryptovaluta. I dagsläget
                ligger räntan på 4,13-7,27% för Bitcoin (BTC), 3,82-7,27% för
                Ethereum (ETH), 4,13-5,26% för Litecoin (LTC), 3,61%-4,91% för
                Ripple (XRP), 2,89-3,92% för 0x (ZRX), 2,53-3,43% för Stellar
                (XLM), 6,18-8,43% för DASH och 4,34-5,90% för EOS.
              </p>
              <p className={articleStyles.text}>
                Det finns inget lägsta belopp att låna ut, så även små belopp
                kan användas för att få ränta. Ytterligare en fördel är att man
                inte tar ut några avgifter i någon som helst form, vilket får
                betraktas som sällsynt.
              </p>
              <p className={articleStyles.text}>
