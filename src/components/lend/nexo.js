          ...
          <Col xs={12} md={{ size: 8, offset: 2 }}>
            ...
            >
              <p className={articleStyles.text}>
                ...
                verksamhet inom konsumentlån, e-handel och fakturaservice.
                Bolaget opererar enligt SEC:s krav och de regler som gäller för
                regionerna de verkar i.
              </p>
              <p className={articleStyles.text}>
              ...
              <p className={articleStyles.text}>
                ...
                som kan användas för att göra köp i affärer och online, eller ta
                ut pengar från en bankomat. Kortet erbjuder även 5% cashback på
                varje köp. Pengarna sätts in i Nexo-plånboken.
              </p>
              <p className={articleStyles.text}>
                För den som vill låna Euros går det att göra med över tio olika
                kryptovalutor som säkerhet. Kryptotillgångarna förvaras precis
                som för Celsius av välrenommerade BitGo, vars tillgångar är
                försäkrade för 100 miljoner USD.
              </p>
              <ul>
                <li>
